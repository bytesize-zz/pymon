...
class AssetsApi(object):
    ...
    def get_corporations_corporation_id_assets(self, corporation_id, **kwargs):  # noqa: E501
        ...
        Return a list of the corporation assets  ---  This route is cached for up to 3600 seconds  --- Requires one of the following EVE corporation role(s): Director  --- [This route has an available update](https://esi.tech.ccp.is/diff/latest/dev/#GET-/corporations/{corporation_id}/assets/)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def get_corporations_corporation_id_assets_with_http_info(self, corporation_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/corporations/{corporation_id}/assets/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
