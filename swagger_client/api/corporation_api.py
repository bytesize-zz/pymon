...
class CorporationApi(object):
    ...
    def get_corporations_corporation_id_blueprints(self, corporation_id, **kwargs):  # noqa: E501
        ...
        Returns a list of blueprints the corporation owns  ---  This route is cached for up to 3600 seconds  --- Requires one of the following EVE corporation role(s): Director  --- [This route has an available update](https://esi.tech.ccp.is/diff/latest/dev/#GET-/corporations/{corporation_id}/blueprints/)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def get_corporations_corporation_id_blueprints_with_http_info(self, corporation_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/corporations/{corporation_id}/blueprints/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_corporations_corporation_id_containers_logs(self, corporation_id, **kwargs):  # noqa: E501
        ...
        Returns logs recorded in the past seven days from all audit log secure containers (ALSC) owned by a given corporation  ---  This route is cached for up to 600 seconds  --- Requires one of the following EVE corporation role(s): Director  --- [This route has an available update](https://esi.tech.ccp.is/diff/latest/dev/#GET-/corporations/{corporation_id}/containers/logs/)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def get_corporations_corporation_id_containers_logs_with_http_info(self, corporation_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/corporations/{corporation_id}/containers/logs/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_corporations_names_with_http_info(self, corporation_ids, **kwargs):  # noqa: E501
        ...
        if 'corporation_ids' in params:
            ...
            collection_formats['corporation_ids'] = 'multi'  # noqa: E501
        if 'datasource' in params:
            query_params.append(('datasource', params['datasource']))  # noqa: E501
        if 'user_agent' in params:
            query_params.append(('user_agent', params['user_agent']))  # noqa: E501
